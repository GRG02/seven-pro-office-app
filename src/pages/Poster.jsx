  ...
  return (
    <Box sx={container}>
      ...
      <Box sx={{ display: 'flex', flexDirection: 'row', justifyContent: 'start', width: '100%', }}>
        <Typography sx={{ fontSize: '2rem', fontWeight: 'bold' }}>เพิ่มโปสเตอร์บนกรอบรูป</Typography>
        <Button sx={{ fontSize: '1.25rem', ml: 'auto', bgcolor: '#14724f', color: 'white' }} onClick={() => { navigate('/') }}>กลับสู่หน้าหลัก</Button>
      </Box>
      <Box sx={{ height: '4.5rem' }} />
      <Grid container spacing={2} sx={{ width: '100%' }}>
        <Grid item size={{ xs: 12, sm: 12, md: 12, lg: 6 }} sx={{ display: 'flex', justifyContent: 'center', bgcolor: 'white' }}>
          <TableContainer sx={{ maxHeight: '60vh', border: '2px solid #14724f' }}>
            <Table aria-label="simple table">
              <TableHead sx={{ bgcolor: '#14724f' }}>
                <TableRow>
